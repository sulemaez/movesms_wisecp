<?php
    ...
    class MoveSMS
    {
        ...
        public function __construct($external_config=[])
        {
            ...
            if(!class_exists("MOVESMSAPI")) include __DIR__.DS."api.php";
            ...
            $this->instance     = new MOVESMSAPI();
            
            $this->instance->set_credentials($config["api-token"],$config['user-name'],$config['sender-id']);
        }
